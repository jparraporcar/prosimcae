...
export const MainSectionTitle: React.FC<MainSectiontitleProps> = (props) => {
  ...
  return (
    <div className={cn(["p-4", props.mainContainerClass])}>
      <h1
        className={cn([
          "text-center text-3xl max-md:text-2xl font-bold bg-gradient-to-r from-slate-600 via-gray-700 to-gray-400 bg-clip-text text-transparent max-md:pb-1",
