    ...
    studyCases: [
      {
        ...
        mediaItems: [
          ...
          },
          {
            ...
            description: "Total Kinetic energy vs total internal energy ",
            alt: "energy balance",
            height: 500,
            src: "/images/post/pen/energy_vs_time.jpeg",
            width: 500,
            className: "object-contain mx-0 mb-2",
          ...
          {
            type: "video",
            title: "Plastic deformation view 2",
            description: "Plastic deformation view 2",
            height: 500,
            src: "/videos/pers_near_ps_otherside.mp4",
            width: 500,
            controls: true,
            muted: true,
            loop: true,
